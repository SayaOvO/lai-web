...
test('change the root node, mount in same index', async () => {
  ...
  await mountDOM(staticVdom, document.body, null)
...
describe('patch children', () => {
  ...
  describe('element vnode', () => {
    ...
    test('added in the middle', async () => {
      const oldVdom = h('div', {}, [h('span', {}, ['A']), h('span', {}, ['C'])])
      const newVdom = h('div', {}, [
        h('span', {}, ['A']),
        h('span', { id: 'b' }, ['B']),
        h('span', {}, ['C']),
    ...
    test('removed from the end', async () => {
      const oldVdom = h('div', {}, [h('span', {}, ['A']), h('span', {}, ['B'])])
    ...
    test('removed from the middle', async () => {
      ...
      const newVdom = h('div', {}, [h('span', {}, ['A']), h('span', {}, ['C'])])
  ...
  describe('fragment vnode', () => {
    ...
    test('add element in the middle', async () => {
      const oldVdom = hFragment([h('span', {}, ['A']), h('span', {}, ['C'])])
      const newVdom = hFragment([
        h('span', {}, ['A']),
        h('span', { id: 'b' }, ['B']),
        h('span', {}, ['C']),
    ...
    test('remove element from the end', async () => {
      const oldVdom = hFragment([h('span', {}, ['A']), h('span', {}, ['B'])])
    ...
    test('remove element from the middle', async () => {
      ...
      const newVdom = hFragment([h('span', {}, ['A']), h('span', {}, ['C'])])
...
async function patch(oldVdom: VNode, newVdom: VNode) {
  await mountDOM(oldVdom, document.body, null)
